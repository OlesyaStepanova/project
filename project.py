...
df['released_month'] = df['released_month'].astype(str).str.pad(width=2, side='left', fillchar='0')
df['released_date'] = pd.to_datetime(df['released_year'].astype(str) + '-' + df['released_month'])
